...
namespace ASP_202.Controllers
{
    public class ForumController : Controller
    {
        ...
        private  int counter;
        private  int Counter { get { return counter++; } set { counter = value; } }
        public IActionResult Index()
        {
            //if(HttpContext.Session.Keys.)
            Counter = 0;
        ...
        public IActionResult Themes([FromRoute] String id)
        {
            ...
            ForumThemesPageModel model = new()
            {
                ...
                {
                    Title = t.Title,
                    Description = _displayService.ReduceString(t.Descriprion, 120),
                    UrlIdString = t.Id.ToString(),
        ...
        public RedirectToActionResult CreateSection(ForumSectionFormModel model)
        {
            ...
            {
                HttpContext.Session.SetString("CreateMessage", "Название не может быть пустым");
            ...
            {
                HttpContext.Session.SetString("CreateMessage", "Описание не может быть пустым");
                HttpContext.Session.SetInt32("IsMessagePositive", 0);
                HttpContext.Session.SetString("SectionTitle", model.Title ?? String.Empty);
                HttpContext.Session.SetString("SectionDescription", model.Description ?? String.Empty);
            }
            else
            {
                ...
                try
                {
                    ...
                    HttpContext.Session.SetString("CreateMessage", "Раздел успешно создан");
                    HttpContext.Session.SetInt32("IsMessagePositive", 1);
                }
                catch
                {
                    HttpContext.Session.SetString("CreateMessage", "Ошибка авторизации");
                    HttpContext.Session.SetInt32("IsMessagePositive", 0);
                    HttpContext.Session.SetString("SectionTitle", model.Title ?? String.Empty);
                    HttpContext.Session.SetString("SectionDescription", model.Description ?? String.Empty);
                }
        ...
        public RedirectToActionResult CreateTopic(ForumTopicFormModel model)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    HttpContext.Session.SetString("CreateMessage", "Вопрос успешно создан");
                    HttpContext.Session.SetInt32("IsMessagePositive", 1);
                }
                catch
                {
        ...
        public RedirectToActionResult CreatePost(ForumPostFormModel model)
        {
            ...
            {
                HttpContext.Session.SetString("CreateMessage", "Ответ не может быть пустым");
                HttpContext.Session.SetInt32("IsMessagePositive", 0);
            ...
            else
            {
                ...
                try
                {
                    ...
                    HttpContext.Session.SetString("CreateMessage", "Ответ успешно создан");
                    HttpContext.Session.SetInt32("IsMessagePositive", 1);
                }
                catch
                {
